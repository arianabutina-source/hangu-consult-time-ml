  ...
  return (
    <div className="-translate-x-2.5">
      <LineChart width={480} height={320} data={merged} margin={{ top: 10, right: 20, bottom: 20, left: 10 }}>
        ...
        <Line type="monotone" dataKey="tpr" name="ROC curve" stroke="#02c39a" dot={false} strokeWidth={2} />
        <Line type="monotone" dataKey="chance" name="Chance" stroke="#05668d" dot={false} strokeDasharray="4 4" />
      </LineChart>
    </div>
  );
}
